    ...
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md shadow-xs border-b border-gray-100 transition-all">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
        <div className="flex items-center justify-between h-20">
          ...
          >
            <div className="relative flex items-center justify-center w-11 h-11 rounded-full border-2 border-slate-900 bg-white shadow-xs transition-transform group-hover:scale-105">
              <CarIcon className="w-6 h-6 text-slate-900" />
              <div className="absolute -right-1 top-3 w-3 h-0.5 bg-[#E11D2A]" />
              <div className="absolute -right-1.5 bottom-3 w-4 h-0.5 bg-[#E11D2A]" />
            </div>
            <div>
              <div className="flex items-center font-black text-2xl tracking-tight text-slate-900">
                <span>Rental-</span>
                <span className="text-[#E11D2A]">ku</span>
              </div>
              <span className="block text-[10px] uppercase font-bold tracking-[0.25em] text-slate-600 -mt-1">
                INDONESIA
              </span>
            </div>
          </button>
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a
              ...
              href={`https://wa.me/${settings.whatsapp}?text=${encodeURIComponent('Halo Rental-ku Indonesia, saya ingin tanya info rental mobil.')}`}
              target="_blank"
